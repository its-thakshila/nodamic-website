...
export const ANIMATION_TIMING = {
  introDelay: 0,    // Model zoom-in waits 0.5s for the CSS loading screen to completely fade out
  textDelay: 0.4,     // Text waits slightly longer so model begins moving first
